...
"""
在插销定位完成后进一步进行边界定位的工作
"""

class Motion_planning():
    def __init__(self, d, padding, padding_error):
        ...
        self.padding_error = padding_error
...
if __name__ == "__main__":
    ...
    # 插座的间距设置估计值与真值的误差
    curve_dis_error = np.array([0.7, 0.8, 0.9, 1.0]) ##这里主要是用于仿真中测试算法的准确定，实际实验中这组参数未知

    M_planning = Motion_planning(d=0.25, padding=curve_dis, padding_error=curve_dis_error)
